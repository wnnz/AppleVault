...
- **📲 真机直连安装**：支持 USB 与已配对 Wi-Fi 设备，安装前自动检查 IPA 完整性、签名结构、最低系统要求和设备类型兼容性。
- **✅ 可靠下载校验**：支持安全断点续传，并通过下载哈希与 ZIP CRC 校验避免使用损坏的 IPA。
- **🔄 自动检查更新**：启动时每日检查一次 GitHub Releases，也可在“关于软件”中手动检查。
